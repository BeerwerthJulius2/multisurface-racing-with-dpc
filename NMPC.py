...
from regulators.dpc_adapter import DPCAdapter
from regulators.nmpc_adapter import NMPCAdapter
...
def main():  # after launching this you can run visualization.py to see the results
    ...
    # init controllers
    initial_state = np.asarray([waypoints[start_point, 1], waypoints[start_point, 2], waypoints[start_point, 3], waypoints[start_point, 5], 0.0, 0.0, 0.0, 0.0])
    ...
    planner_nmpc = NMPCAdapter(initial_state=initial_state, waypoints=waypoints)
